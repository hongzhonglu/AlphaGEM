...
def main():
    ...
    parser.add_argument('--USalignfilter',type=float,help='US alignment filter',default=0.7)
    parser.add_argument('--TMscore', type=float,default=0.85,help='filter TMscore')
    parser.add_argument('--upTMscore', type=float, default=0.9, help='safe TMscore')
    parser.add_argument('--TMscoretrans', type=float,default=0.85, help='filter TMscoretrans')
    parser.add_argument('--coverage', type=float,default=0.9, help='filter coverage')
    parser.add_argument('--upcoverage', type=float, default=0.95, help='safe coverage')
    parser.add_argument('--coveragetrans',type=float,default=0.9, help='filter coveragetrans')
